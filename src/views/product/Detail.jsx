              ...
              <div className="col-md-7">
                ...
                <div className="mb-3">
                  ...
                  <span className="text-muted small">
                    42 Reseñas and 4 calificaciones
                  </span>
                </div>
                <dl className="row small mb-3">
                  <dt className="col-sm-3">Disponibilidad</dt>
                  <dd className="col-sm-9">En existencia</dd>
                  <dt className="col-sm-3">Vendido por</dt>
                  <dd className="col-sm-9">Tienda autorizada</dd>
                  <dt className="col-sm-3">Talla</dt>
