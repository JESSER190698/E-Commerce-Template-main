    ...
    return (
      <React.Fragment>
        ...
        <div className="bg-info bg-gradient p-3 text-center mb-3">
          <h4 className="m-0">Explora la colecion de moda!</h4>
        </div>
            ...
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                  ...
                  alt="..."
                />
                <div className="text-center h6">Ropa de Caballero</div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                  ...
                  alt="..."
                />
                <div className="text-center h6">Ropa de dama</div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                  ...
                  alt="..."
                />
                <div className="text-center h6">Relojes inteligentes</div>
              </Link>
            </div>
            <div className="col-md-3">
              <Link to="/" className="text-decoration-none">
                <img
                  ...
                  alt="..."
                />
                <div className="text-center h6">Calzado</div>
              </Link>
            </div>
          </div>
        </div>
